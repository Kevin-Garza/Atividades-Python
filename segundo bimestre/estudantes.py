...
turma = Turma()
estudante1 = Estudante("Cleber", 24, 6.9, 7)
estudante2 = Estudante("Paulo", 18, 5.8, 9)
estudante3 = Estudante("Luiz Fernando", 32, 9.8, 1)
estudante4 = Estudante("Thiago", 20, 10.0, 8)
